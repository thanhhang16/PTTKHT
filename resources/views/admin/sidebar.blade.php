        ...
        <nav class="mt-2">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.create.project')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('admin.index.project')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Views</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{route('admin.report.timesheet')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('admin.change.timestamp')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('admin.change.profile')}}" class="nav-link">
